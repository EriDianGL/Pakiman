...
imagenes["Cauchin"] = "./images/cauchin.png";
imagenes["Pokacho"] = "./images/pokacho.png";
imagenes["Tocinauro"] = "./images/tocinauro.png";
...
for (var p of coleccion) {
  // para cada variable dentro de coleccion coloquelo dentro de "p"(para cada "p" en coleccion)
  p.mostrar();
}
